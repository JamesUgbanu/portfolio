...
const itemData = [
    {
        ...
        desciption: 'An application that accepts customers queries through phone calls and WhatsApp. These calls are logged and inquiry passed along to a CRM.',
    },
    {
        img: '/images/rmonitor.png',
        name: 'RMonitor',
        desciption: 'An advanced and automated telemetry system where measurement of temperature, pressure, rate of flow and other parameters of remote assets can be obtained without any physical presence',
    },
    {
